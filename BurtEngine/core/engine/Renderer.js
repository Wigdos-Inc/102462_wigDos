...
export class WebGLRenderer {
  constructor(canvas) {
    ...
    this.grid = new Mesh({gl: this.gl}, this.GeometryBuilder.createGrid(), [0.5, 0.5, 0.5]);
  ...
  render(meshes, camera) {
    this.clear(this.backgroundColor[0], this.backgroundColor[1], this.backgroundColor[2], this.backgroundColor[3]);
  ...
  updateCamera(camera) {
        ...
        this.viewMatrix = Matrix4.lookAt(
            ...
            camera.up || new Engine.Vec3(0, 1, 0)
        );
    }
