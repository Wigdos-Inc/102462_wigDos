export class GLBParser {
    ...
    ConvertToFlatMesh(model) {
        ...
        Object.entries(model.geometries).forEach(([id, geom]) => {
            ...
            if (geom.faces && geom.faces.length > 0) {
                for (let i = 0; i < geom.faces.length; i++) {
                    ...
                    allIndices.push(
                        (face.v0 || 0) + vertexOffset,
                        (face.v1 || 0) + vertexOffset,
                        (face.v2 || 0) + vertexOffset
                    );
                }
            }
        ...
        return {
            ...
            texCoords: new Float32Array(allUVs)
        };
    }
}
